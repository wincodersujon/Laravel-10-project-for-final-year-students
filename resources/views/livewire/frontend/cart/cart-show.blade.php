<div>
    <div class="py-3 py-md-5">
        <div class="container">
                    ...
                    <div class="shopping-cart">
                        ...
                        <div class="cart-item">
                            <div class="row">
                                ...
                                <div class="col-md-2 col-7 my-auto">
                                    <div class="quantity">
                                        <div class="input-group">
                                            <button type="button" wire:loading.attr="disabled" wire:click="decrementQuantity({{ $cartItem->id }})"
                                                 class="btn btn1"><i class="fa fa-minus"></i>
                                            </button>
                                            <input type="text" value="{{ $cartItem->quantity }}"readonly class="input-quantity" />
                                            <button type="button" wire:loading.attr="disabled" wire:click="incrementQuantity({{ $cartItem->id }})"
                                                 class="btn btn1"><i class="fa fa-plus"></i>
                                            </button>
                                        </div>
                                    </div>
                                </div>
                                {{-- when qnty update price will update --}}
                                ...
                                {{-- remove cart item ->CartShow->function name 'removeCartItem' --}}
            ...
            {{-- Total price count on @php @endphp fn --}}
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h5 >Get the best item & offers <a href="{{ url('/collections') }}"class="btn btn-success px-3">shop now</a></h5>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        ...
                        <hr>
                        <a href="{{ url('/checkout') }}" class="btn btn-warning w-100">Chechout</a>
                    </div>
                </div>
            </div>
