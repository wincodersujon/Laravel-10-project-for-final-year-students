...
<div>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2023 - Win Coder Sujon - Lara-ecommerce. All rights reserved.</p>
                </div>
                <div class="col-md-4">
                    <div class="social-media text-light">
                        ...
                        <a href="{{ $appSetting->linkedin }}" target="_blank"><i class="fa fa-linkedin"></i></a>
                        @endif --}}
                        @if($appSetting->youtube)
                        <a href="https://www.youtube.com/@wincoder9"><i class="fa fa-youtube"></i></a>
                        @endif
