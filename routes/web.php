...
Route::get('/collections/{category_slug}/{product_slug}','productView');//Display related products view
Route::get('/','index');
...
Route::middleware('auth')->group(function(){
    ...
    Route::get('stripe/{totalprice}',[App\Http\Controllers\Frontend\CheckoutController::class,'stripe']);
    Route::post('stripe/{totalprice}',[App\Http\Controllers\Frontend\CheckoutController::class,'stripePost'])->name(
        'stripe.post');
